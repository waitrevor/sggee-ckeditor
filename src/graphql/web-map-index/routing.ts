...
const updateRouteParametersRussiaPoland = (searchCriteriaRef: Ref, currentPage: Ref, resultsPerPage: Ref, routeParameters: Ref, router: Router, pushRoute: boolean = false) => {
...
const updateSearchCriteriaFromRouteRussiaPoland = (searchCriteriaRef: Ref, currentPage: Ref<number>, resultsPerPage: Ref<number>, route: RouteLocationNormalizedLoaded) => {
  if (searchCriteriaRef?.value && searchCriteriaRef.value.searchFields) {
...
export {
  updateRouteParametersRussiaPoland,
  updateSearchCriteriaFromRouteRussiaPoland
};