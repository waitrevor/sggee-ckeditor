...
<template>
  ...
  <div class="person-card">
    <div class="name">
      <div>
        <template v-if="individualData.name">
          {{ individualData.name + ' ' }}
        </template>
    ...
    <div class="info">
      <div>
        ...
        <template v-if="individualData.eventyear">
          {{ individualData.eventyear }}
        </template>
        <template v-else>
      ...
      <div>
        ...
        <template v-if="individualData.recordtype">
          <template v-if="individualData.recordtype == 'b' || individualData.recordtype == 'B'">
            Birth
          </template>
          <template v-else-if="individualData.recordtype == 'm' || individualData.recordtype == 'M'">
            Marriage
          </template>
          <template v-else-if="individualData.recordtype == 'd' || individualData.recordtype == 'D'">
            Death
          </template>
          <template v-else>
            {{ individualData.recordtype }}
          </template>
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
    ...
    <div class="parents">
      <div>
        ...
        <template v-if="individualData.parish">
          {{ individualData.parish }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
      ...
      <div>
        ...
        <template v-if="individualData.extractor">
          {{ individualData.extractor }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
