...
<template>
  ...
  <div class="person-card">
    ...
    <div class="info">
      ...
      <div>
        <!-- Full Details -->
        <strong>Place Buried: </strong>
        <template v-if="individualData.place_buried">
          {{ individualData.place_buried + ' ' }}
        </template>
        <template v-else>
        ...
        <div>
          ...
          <template v-if="individualData.death_daymonth">
            {{ individualData.death_daymonth + ' ' }}
          </template>
          <template v-if="individualData.year">
            {{ individualData.year }}
          </template>
          <template v-if="!individualData.death_daymonth && !individualData.year">
            <span class="missing-text">{{ missingPlaceholdlerText }}</span>
          </template>
        </div>
        ...
        <template v-if="individualData.cause_of_death">
          {{ individualData.cause_of_death + ' ' }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
    ...
    <div class="parents">
      <div>
        <strong>Father's Given Name: </strong>
      ...
      <div>
        <strong>Mother's Given Name: </strong>
        <template v-if="individualData.mothers_givenname">
          {{ individualData.mothers_givenname }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
      ...
      <div>
        <strong>Mother's Surname: </strong>
        <template v-if="individualData.mothers_surname">
          {{ individualData.mothers_surname }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
