  ...
  <div v-for="(entry, index) in props.searchResults.data" :key="entry.id" class="card">
    ...
    <div v-if="searchResults.moreDetails[index]" class="details-container">
      <div style="margin-left: 10px; margin-bottom: 10px;">
        ...
        <LabeledItem :entry="entry" :label="'Book'" :field="'churchbook'"/>
      ...
      <div class="offset-section">
        <LabeledItem :entry="entry" :label="'Baptism Date'" :field="'bap_date'"/>
        <LabeledItem :entry="entry" :label="'Baptism Year'" :field="'bap_year'"/>
        <LabeledItem :entry="entry" :label="'Baptism Place'" :field="'bap_place'"/>
      </div>

      <div class="offset-section">
        <LabeledItem :entry="entry" :label="'Godfather'" :field="'godfather'"/>
        <LabeledItem :entry="entry" :label="'Godmother'" :field="'godmother'"/>
...
import Person from './PersonBirth.vue';
