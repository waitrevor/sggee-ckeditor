  ...
  <div class="person-card">
    ...
    <div class="info">
      ...
      <div>
        ...
        <template v-if="individualData.birth_place">
          {{ individualData.birth_place + ' ' }}
        </template>
        <template v-else>
        ...
        <div>
          ...
          <template v-if="individualData.birth_date">
            {{ individualData.birth_date + ' ' }}
          </template>
          <template v-if="individualData.birth_year">
            {{ individualData.birth_year }}
          </template>
          <template v-if="!individualData.birth_date && !individualData.birth_year">
            <span class="missing-text">{{ missingPlaceholdlerText }}</span>
          </template>
        </div>
      </div>
    ...
    <div class="parents">
      ...
      <div>
        ...
        <template v-if="individualData.mother_givenname">
          {{ individualData.mother_givenname }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
      ...
      <div>
        ...
        <template v-if="individualData.mother_surname">
          {{ individualData.mother_surname }}
        </template>
        <template v-else>
          <span class="missing-text">{{ missingPlaceholdlerText }}</span>
        </template>
