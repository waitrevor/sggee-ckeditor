...
<template>
  <div class="map-card">
    <div class="village">
      <LabeledItem :entry="entryData" :label="'Place'" :field="'place'"/>
    </div>
    
    <div class="province">
      <LabeledItem :entry="entryData" :label="'Place (w/ diacritics)'" :field="'originalspelling'"/>
    </div>

    <div class="mapgrid">
      <LabeledItem :entry="entryData" :label="'Map Coordinate'" :field="'mapcoord'"/>
    </div>
